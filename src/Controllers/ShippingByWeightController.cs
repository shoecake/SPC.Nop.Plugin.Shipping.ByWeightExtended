...
{
    [AdminAuthorize]
    public class ShippingByWeightExtendedController : BasePluginController
    {
   ...
   //     private readonly Data.ProductMapToShippingMethodObjectContext _prodMapObjectContext;
    ...
    //        this._prodMapObjectContext = prodMapObjectContext;
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/SPC.Shipping.ShippingByWeightExtended/Views/ShippingByWeightExtended/Configure.cshtml", model);
        }
       ...
       //     _prodMapObjectContext.Install();
        ...
        public ActionResult RatesList(DataSourceRequest command)
        {
            ...
            var records = _ShippingByWeightExtendedService.GetAll(command.Page - 1, command.PageSize);
            var sbwModel = records.Select(x =>
                {
                    ...
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.From"), m.From);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.To"), m.To);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.AdditionalFixedCost"), m.AdditionalFixedCost);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.RatePerWeightUnit"), m.RatePerWeightUnit);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.LowerWeightLimit"), m.LowerWeightLimit);
                    htmlSb.Append("<br />");
                    htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.ByWeightExtended.Fields.PercentageRateOfSubtotal"), m.PercentageRateOfSubtotal);
        ...
        public ActionResult RateDelete(int id)
        {
            ...
            var sbw = _ShippingByWeightExtendedService.GetById(id);
            if (sbw != null)
                _ShippingByWeightExtendedService.DeleteShippingByWeightExtendedRecord(sbw);
        ...
        public ActionResult EditPopup(int id)
        {
            ...
            return View("~/Plugins/SPC.Shipping.ShippingByWeightExtended/Views/ShippingByWeightExtended/EditPopup.cshtml", model);
        }
        [HttpPost]
        [AdminAntiForgery]
        public ActionResult EditPopup(string btnId, string formId, ShippingByWeightModel model)
        {
            ...
            var sbw = _ShippingByWeightExtendedService.GetById(model.Id);
            if (sbw == null)
                //No record found with the specified id
                return RedirectToAction("Configure");
            ...
            _ShippingByWeightExtendedService.UpdateShippingByWeightExtendedRecord(sbw);
